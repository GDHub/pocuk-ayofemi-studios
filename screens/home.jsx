...
function ServicesStrip() {
  ...
  const services = [
    { id: "portrait", num: "01", title: "Portraits", desc: "Studio sittings, headshots, and intimate sessions on film or digital.", from: 180 },
    { id: "editorial", num: "02", title: "Editorial", desc: "Magazine commissions and brand editorials with full creative direction.", from: 650 },
    { id: "wedding", num: "03", title: "Weddings", desc: "Documentary coverage from quiet rooms to the loudest dance floor.", from: 1950 },
    { id: "commercial", num: "04", title: "Commercial", desc: "Lookbooks, product, and campaign photography for considered brands.", from: 900 },
  ];
  return (
